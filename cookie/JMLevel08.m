...
-(void)addStars{
    ...
    if (canGetStars == false) {
        ...
        star1.position = CGPointMake(self.frame.size.width/1.7, self.frame.size.height/1.9);
        ...
        star2.position = CGPointMake(self.frame.size.width/2, self.frame.size.height/1.2);
...
-(void)addWalls{
    ...
    wall.position = CGPointMake(self.frame.size.width/6.5, self.frame.size.height/3);
