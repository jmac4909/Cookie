...
//  cookie
//
//  Created by Jeremy Mackey on 11/8/16.
...
-(void)setUpLevel{
    ...
    cookieStartPoint = CGPointMake(self.frame.size.width/7, self.frame.size.height/2);
...
-(void)addStars{
    ...
    if (canGetStars == false) {
        ...
        star1.position = CGPointMake(self.frame.size.width/10, self.frame.size.height/1.4);
        ...
        star2.position = CGPointMake(self.frame.size.width/7, self.frame.size.height/1.2);
        ...
        star3.position = CGPointMake(self.frame.size.width/5.5, self.frame.size.height/1.4);
...
-(void)addWalls{
    ...
    wall.position = CGPointMake(self.frame.size.width/7, self.frame.size.height/3);
...
-(void)nextLevelButtonPress{
    ...
    JMLevel08 *scene = [[JMLevel08 alloc]initWithSize:self.size];
...
-(void)restart{
    ...
    JMLevel07 *scene = [[JMLevel07 alloc]initWithSize:self.size];
    [self.view presentScene:scene];
