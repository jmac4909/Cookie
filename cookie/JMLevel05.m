...
-(void)addStars{
    ...
    if (canGetStars == false) {
        ...
        star1.position = CGPointMake(self.frame.size.width/2, self.frame.size.height/1.15);
        ...
        star2.position = CGPointMake(self.frame.size.width/1.2, self.frame.size.height/1.25);
        ...
        star3.position = CGPointMake(self.frame.size.width/1.5, self.frame.size.height/1.2);
