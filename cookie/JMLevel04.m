...
-(void)addStars{
    ...
    if (canGetStars == false) {
        ...
        star2.position = CGPointMake(self.frame.size.width/1.2, self.frame.size.height/4);
...
-(void)restart{
    ...
    JMLevel04 *scene = [[JMLevel04 alloc]initWithSize:self.size];
    [self.view presentScene:scene];
