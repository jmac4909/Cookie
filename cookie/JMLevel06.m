...
-(void)addStars{
    ...
    if (canGetStars == false) {
        ...
        star1.position = CGPointMake(self.frame.size.width/1.2, self.frame.size.height/1.7);
        ...
        star2.position = CGPointMake(self.frame.size.width/1.2, self.frame.size.height/3);
        ...
        star3.position = CGPointMake(self.frame.size.width/6, self.frame.size.height/1.9);
...
-(void)addWalls{
    ...
    wall.position = CGPointMake(self.frame.size.width/2, self.frame.size.height/2.5);
